...
import leer.hope4d.common.constants.enums.CommonEnum;
import leer.hope4d.common.exception.GlobalException;
import leer.hope4d.common.properties.QiniuProperties;
import leer.hope4d.common.utils.R;
import leer.hope4d.entity.QiNiuEntity;
import leer.hope4d.common.properties.HopeProperties;
 ...
 * 文件上传的DEMO请看 /test/java/cn/leer/UploadDemo.java 测试类。
...
public class QiniuController {
    ...
    @Autowired
    private HopeProperties properties;
        ...
        try {
            ...
            while (fileListIterator.hasNext()) {
                ...
                for (FileInfo item : items) {
                    QiNiuEntity qiNiuEntity = new QiNiuEntity(item.hash, item.key, item.mimeType, item.fsize, qiniu.getUrl() + item.key);
